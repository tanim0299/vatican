                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control"  type='text' name='partner_name'  id='partner_name' value='{{$data->partner_name}}' />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control"  type='text' name='partner_name_italic'  id='partner_name_italic' value='{{$data->partner_name_italic}}' />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <img src="{{asset('Backend/img/PartnerImage')}}/{{$data->image}}" alt="" class="img-fluid" style="height: 80px;">
                            </div>
                        </div>
