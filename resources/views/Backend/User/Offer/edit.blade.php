                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control"  type='text' name='offer_name'  id='offer_name' value='{{$data->offer_name}}' />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control"  type='text' name='offer_name_italic'  id='offer_name_italic' value='{{$data->offer_name_italic}}' />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <img src="{{asset('Backend/img/OfferImage')}}/{{$data->image}}" alt="" class="img-fluid" style="height: 80px;">
                            </div>
                        </div>
