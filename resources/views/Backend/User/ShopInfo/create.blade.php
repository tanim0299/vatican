                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control"  type='text' name='shop_name'  id='shop_name' value='' />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control"  type='text' name='shop_name_italic'  id='shop_name_italic' value='' />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                <label>Adress</label>
                                <textarea name="adress" id="summernote" cols="10" rows="5" class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <textarea name="adress_italic" id="summernote1" cols="10" rows="5" class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <textarea name="location" id="" cols="10" rows="5" class="form-control"></textarea>
                            </div>
                        </div>
