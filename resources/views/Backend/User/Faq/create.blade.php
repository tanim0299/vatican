                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control"  type='text' name='questions'  id='questions' value='' />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control"  type='text' name='questions_italic'  id='questions_italic' value='' />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                <label>Answer</label>
                                <textarea name="answer" id="summernote" cols="10" rows="5" class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <textarea name="answer_italic" id="summernote1" cols="10" rows="5" class="form-control"></textarea>
                            </div>
                        </div>
